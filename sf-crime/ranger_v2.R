...
###Feature処理完了。ランダムフォレストを生成####

fit <- ranger(Category ~ DayOfWeek + Year + Month + Isholiday + Isbeforeholiday + Hour + Iscorner + Grid_no + X + Y, data = TRAIN, write.forest=TRUE,probability=TRUE)
